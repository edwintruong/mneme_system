...
Source file: `8T9Olnto5GDBzUjXyP1ybY`, UI section `2143:4235`.
...
Primary tokens: background `#F8F6FD`, primary `#7758E2`, primary soft `#F1EEFC`, ink `#0E0727`, muted `#9490A2`, neutral surface `#F5F5F7`.
